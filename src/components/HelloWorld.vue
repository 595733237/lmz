		...
		<el-row :gutter="24">
			<el-col :span="20" :offset="2">
				<div class="table" id="table">
					<el-table :data="tableData" @selection-change='selectRow' style="width: 100%;" max-height="500">
						...
						<el-table-column fixed="right" label="操作" width="200">
							<template slot-scope="scope">
								...
								<el-button @click="handleClick(scope.row)" type="text" size="middle"><i class="el-icon-view"></i><router-link to="/text">查看</router-link></el-button>
					...
					<div class="delbtn">
				      	<p><el-button class="btn_w" @click.prevent="delData()">多行删除</el-button></p>
				    </div>
				</div>
